...
//                pw.close();
                ...
                GetMethod gm = new GetMethod("http://localhost:8080/Lab3/Ggg?type=request&firstname=get&lastname=request");
                hc.executeMethod(gm);
            ...
            if(action.equals("forward")) {
                ...
                PostMethod gm = new PostMethod("http://localhost:8080/Lab3/Ggg");
                gm.addParameter("action",action);
                gm.addParameter("firstname",rq.getParameter("firstname"));
                gm.addParameter("lastname",rq.getParameter("lastname"));
                hc.executeMethod(gm);
                rs.setContentType("text/html");
                PrintWriter pw = rs.getWriter();
                pw.println(gm.getResponseBodyAsString());
